...
<div id="termos" class="container">
      <h3 class="center-align">TERMOS E CONDIÇÕES GERAIS DE USO
          DO APLICATIVO "Wetter"</h1><br/>
      <p>Estes termos e condições gerais de uso aplicam-se aos serviços prestados pela pessoa jurídica <b>Wetter Company</b>, devidamente registrada sob o CNPJ n. 89.647.999/0001-79, e-mail: Company@wetter.com, com sede em:</p>
      <p class="center-align">IFSP - Campus Caraguatatuba - Sala 209;<br/>
          Av. Bahia, 1739 - Indaiá, Caraguatatuba, SP;<br/>
          CEP: 11665-071;</p>
      <p class='center-align'>representada por:<br/>
          <b>Rebeca Castilho Camargo</b>, na qualidade de: Presidente, CPF n. 493.112.298-14,<br/> Carteira de Identidade (RG) n. 47.465.953-7, expedida por SSP.</p>
      <p>doravante denominada <b>EDITOR DO APLICATIVO</b>,<br/>
          por meio do aplicativo <b>Wetter</b>.</p><br/>
      <h5>I. DO OBJETO</h5>
      <p>O aplicativo <b>Wetter</b> caracteriza-se pela prestação dos seguintes serviços:
          Sistema feito com a plataforma Arduino com a finalidade de irrigar plantações de pequeno porte de forma automatizada. Oferece os seguintes serviços:</p>
      <p>-Irrigação automática que trabalha nas condições climáticas e de solo favoráveis à uma determinada cultura;</p>
      <p>-Gráficos de verificação de solo e irrigação;</p>
      <p>-Cadastro de cultura e suas condições de florescimento;</p>
      <p>-Verificação de atualizações, dando suporte a correções de erros e novas funções.<p/><br/>
      <h5>II. DA ACEITAÇÃO DOS TERMOS E CONDIÇÕES GERAIS DE USO</h5>
      <p>Todos aqueles que desejarem ter acesso aos serviços ofertados através do aplicativo <b>Wetter</b> deverão, primeiramente, se informar sobre as regras que compõem o presente instrumento, as quais ficarão disponíveis para pronta e ampla consulta, em link direto no próprio aplicativo.</p>
      <p>Ao utilizar o aplicativo <b>Wetter</b>, o usuário aceita integralmente as presentes normas e compromete-se a observá-las, sob risco de aplicação das penalidades cabíveis. Antes de iniciar qualquer navegação no aplicativo, o usuário deverá cientificar-se de eventuais modificações ou atualizações ocorridas neste termos.</p>
      ...
      <p>Caso não concorde com quaisquer das regras aqui descritas, o usuário deve, imediatamente, abster-se de utilizar o serviço. Se for de seu interesse, poderá, ainda, entrar em contato com o serviço de atendimento ao cliente, para apresentar-lhe as suas ressalvas.</p><br/>
      <h5>III. DA NAVEGAÇÃO</h5>
      <p>O editor do aplicativo <b>Wetter</b> se compromete a utilizar todas as soluções técnicas à sua disposição para permitir o acesso ao serviço 24 (vinte e quatro) horas por dia, 7 (sete) dias por semana. Entretanto, ele poderá, a qualquer momento, interromper, limitar ou suspender o acesso ao aplicativo ou a algumas de suas páginas, a fim de realizar atualizações, modificações de conteúdo ou qualquer outra ação julgada necessária para o seu bom funcionamento.</p>

      <p>Os presentes termos e condições gerais de uso se aplicam a todas as extensões do aplicativo <b>Wetter</b> em redes sociais ou em comunidades, tanto as já existentes, quanto aquelas ainda a serem implementadas.</p><br/>


      <h5>IV. DA GESTÃO DO APLICATIVO</h5>
      <p>Para a boa gestão, o editor do aplicativo <b>Wetter</b> poderá, a qualquer momento:</p>

       <p>a) suspender, interromper ou limitar o acesso a todo ou a parte do aplicativo a uma categoria específica de internautas;</p>

       <p>b) remover toda informação que possa perturbar o funcionamento do aplicativo ou que esteja em conflito com normas de Direito brasileiro ou de Direito internacional;</p>

       <p>c) suspender o aplicativo, a fim de realizar atualizações e modificações.</p></br>


      <h5>V. DO CADASTRO</h5>
      <p>Os serviços disponibilizados no aplicativo <b>Wetter</b> apenas poderão ser acessados por pessoas plenamente capazes, conforme o Direito brasileiro. Todos aqueles que não possuírem plena capacidade civil - menores de 18 anos não emancipados, pródigos, ébrios habituais ou viciados em tóxicos e pessoas que não puderem exprimir sua vontade, por motivo transitório ou permanente - deverão ser devidamente assistidos por seus representantes legais, que se responsabilizam pelo cumprimento das presentes regras.</p>

      <p>As pessoas jurídicas também poderão se cadastrar, por meio de seus representantes legais.</p>

      <p>Ao usuário, será permitido manter apenas uma conta junto ao aplicativo <b>Wetter</b>. Contas duplicadas serão automaticamente desativadas pelo editor do aplicativo, sem prejuízo de demais penalidades cabíveis.</p>

      <p>O editor se reserva o direito de retirar a qualquer momento um link levando ao seu próprio serviço, se a página de origem não estiver conforme a sua política editorial.</p>
      ...
      <p>O usuário poderá, a qualquer tempo e sem necessidade de justificação, requerer o cancelamento de seu cadastro junto ao aplicativo <b>Wetter</b>. O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.</p><br/>


    <h5>VI. DAS RESPONSABILIDADES</h5>
    <p>O editor se responsabilizará pelos defeitos ou vícios encontrados nos serviços prestados pelo aplicativo <b>Wetter</b>, desde que tenha lhes dado causa. Defeitos ou vícios técnicos ou operacionais originados no próprio sistema do usuário não serão de responsabilidade do editor.</p>
    ...
    <p class='center-align'>a) pela correta utilização do aplicativo e de seus serviços, prezando pela boa convivência, pelo respeito e pela cordialidade no relacionamento com os demais usuários;</p>

    <p class='center-align'>b) pelo cumprimento das regras contidas neste instrumento, bem como normas de Direito nacional e de Direito internacional;</p>

    <p class='center-align'>c) pela proteção dos dados de acesso à sua conta (login e senha).</p>

    <p>O editor não será responsável:</p>

    <p class='center-align'>a) pelas características intrínsecas da internet, principalmente relativas à confiabilidade e à procedência das informações circulando nesta rede;</p>

    <p class='center-align'>b) pelos conteúdos ou atividades ilícitas praticadas através de seu aplicativo.</p><br/>


    <h5>VII. DOS LINKS EXTERNOS</h5>

    <p>O aplicativo <b>Wetter</b> pode conter links externos redirecionando o usuário para outras páginas da internet, sobre os quais o editor não exerce controle. Apesar das verificações prévias e regulares realizadas pelo editor, ele se isenta de qualquer responsabilidade sobre o conteúdo encontrado nestes sites e serviços.</p>

    <p>Poderão ser incluídos links nas páginas e nos documentos do aplicativo <b>Wetter</b>, desde que não sirvam para fins comerciais ou publicitários. Esta inclusão dependerá de autorização prévia do editor.</p>

    <p>Não será autorizada a inclusão de páginas que divulguem quaisquer tipos de informações ilícitas, violentas, polêmicas, pornográficas, xenofóbicas, discriminatórias ou ofensivas.</p><br/>



    <h5>VIII. DOS DIREITOS AUTORAIS</h5>

    <p>A estrutura do aplicativo <b>Wetter</b>, bem como os textos, os gráficos, as imagens, as fotografias, os sons, os vídeos e as demais aplicações informáticas que o compõem são de propriedade do editor e são protegidas pela legislação brasileira e internacional referente à propriedade intelectual.</p>
    ...
    <p>O acesso não gera para o usuário qualquer direito de propriedade intelectual relativo a elementos do aplicativo, os quais restam sob a propriedade exclusiva do editor.
    É vedado ao usuário incluir no aplicativo dados que possam modificar o seu conteúdo ou sua aparência.</p><br/>


    <h5>IX. DA POLÍTICA DE PRIVACIDADE</h5>
    ...
    <p>•Seus dados pessoais serão coletados de forma adequada, pertinente e limitada às necessidades do objetivo para os quais eles são processados (minimização dos dados);</p>

    <p>•Seus dados pessoais serão exatos e atualizados sempre que necessário, de maneira que os dados inexatos sejam apagados ou retificados quando possível (exatidão);</p>
    ...
    <p>•Direito à eliminação dos dados (direito ao esquecimento): é o direito do usuário de ter seus dados apagados do aplicativo;</p>

    <p>•Direito à limitação do tratamento dos dados: é o direito do usuário de limitar o tratamento de seus dados pessoais, podendo obtê-la quando contesta a exatidão dos dados, quando o tratamento for ilícito, quando o aplicativo não precisar mais dos dados para as finalidades propostas e quando tiver se oposto ao tratamento dos dados e em caso de tratamento de dados desnecessários;</p>
    ...
    <p>O pedido deverá ser enviado ao e-mail: Company@wetter.com, ou por correio, ao seguinte endereço:</p>
        ...
        <div class='center-align'><p>IFSP - Campus Caraguatatuba, 209;</p>
        <p>Av. Bahia, 1739 - Indaiá, Caraguatatuba, SP;</p>
        <p>CEP: 11665-071.</p></div>
    ...
    <p>Serão coletados todos os dados necessários ao cadastro do usuário, como nome completo ou razão social, número do CPF ou CNPJ, e-mail e endereço do usuário, requisitos necessários para acessar determinados serviços oferecidos pelo aplicativo.</p>

    <p>Eventualmente poderão ser coletados outras categorias de dados, desde que fornecidos com o consentimento do usuário, ou ainda em razão de interesse legítimo ou demais motivos permitidos em lei.</p>
    ...
    <p>O usuário tem o direito de retirar o seu consentimento a qualquer momento, não comprometendo a licitude dos dados pessoais tratados antes de sua retirada. A retirada do consentimento poderá ser feita pelo e-mail: Company@wetter.com, ou por correio enviado ao seguinte endereço:</p>

    <div class='center-align'><p>IFSP - Campus Caraguatatuba, 209;</p>
        <p>Av. Bahia, 1739 - Indaiá, Caraguatatuba, SP;</p>
        <p>CEP: 11665-071.</p></div><br/>
    ...
    <p>Os dados de cadastro serão utilizados para permitir o acesso ao usuário de determinados conteúdos do aplicativo exclusivos para usuários cadastrados.</p>
    ...
    <p class='center-align'>Os dados referentes ao cliente que solicitar a nossa plataforma serão mantidos afim de estabelecer estatísticas de compra do nosso sistema. Assim como a necessidade de verificar a veracidade da compra do sistema pelo mesmo. Sendo assim, não há um tempo estabelecido para exclusão dos dados que estejam sobre nossa tutela. Poderão ser excluídos os dados se por ventura a Wetter Company descontinuar sua participação no mercado.</p>
    ...
    <div class='center-align'><p>IFSP - Campus Caraguatatuba - Sala 209;</p>
        <p>Av. Bahia, 1739 - Indaiá, Caraguatatuba, SP;</p>
        <p>CEP: 11665-071.</p></div>

    <p>O aplicativo possui também os seguintes responsáveis pelo tratamento dos dados pessoais coletados:</p>
    <div class='center-align'><p>IFSP - Campus Caraguatatuba - Sala 209;</p>
    <p>Av. Bahia, 1739 - Indaiá, Caraguatatuba, SP;</p>
        <p>CEP: 11665-071;</p></div>
    ...
    <p>A violação de dados pessoais é uma violação da segurança que provoque, de modo acidental ou ilícito, a destruição, a perda, a alteração, a divulgação ou o acesso, não autorizados, a dados pessoais transmitidos, conservados ou sujeitos a qualquer outro tipo de tratamento.</p>
    ...
    <h5>X. DO SERVIÇO DE ATENDIMENTO AO USUÁRIO</h5>

    <p>Em caso de dúvidas, sugestões ou problemas com a utilização do aplicativo </b>Wetter</b>, o usuário poderá contatar diretamente o seu serviço de atendimento, através do endereço de e-mail: Company@wetter.com, bem como do telefone: (12) 3885-2130. Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários:
        De segunda à sexta. Dos 12:00 até 18:00.</p>

    <p>O usuário poderá, ainda, optar por enviar correspondência ao endereço da sede do aplicativo </b>Wetter</b>, informado no início deste documento.</p>


    <h5>XI. DAS SANÇÕES</h5>
    <p>Sem prejuízo das demais medidas legais cabíveis, o editor do aplicativo <b>Wetter</b> poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:</p>
    ...
    <p>e) cujo comportamento constitua ou possa vir a importar ofensa ou dano a terceiro ou ao próprio aplicativo.</p><br/>


          <h5>XII. DAS ALTERAÇÕES</h5>
    </p>A presente versão dos termos e condições gerais de uso foi atualizada pela última vez em: 16/11/2018.</p>

    <p>O editor se reserva o direito de modificar, a qualquer momento e sem qualquer aviso prévio, o aplicativo e os serviços, bem como as presentes normas, especialmente para adaptá-las às evoluções do aplicativo <b>Wetter</b>, seja pela disponibilização de novas funcionalidades, seja pela supressão ou modificação daquelas já existentes.</p>

    <p>Dessa forma, convida-se o usuário a consultar periodicamente esta página para verificar as atualizações.</p>

    <p>O usuário que utilizar o serviço, após realizadas modificações nos termos e condições gerais, demonstra a sua concordância com as novas normas. Caso discorde de alguma das modificações, deverá pedir, imediatamente, o cancelamento de sua conta e apresentar a sua ressalva ao serviço de atendimento, se assim o desejar.</p><br/>
    ...
    <div class='center-align'><p><i>Seja bem-vindo(a)!</p>
        <p>A equipe do aplicativo <b>Wetter</b> lhe deseja uma excelente navegação!</i></p></div>
